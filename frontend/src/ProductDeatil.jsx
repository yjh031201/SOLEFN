...
import './style.css'; // 제공된 CSS 파일을 연동합니다.

const ProductDetail = () => {
  const [activeTab, setActiveTab] = useState('spec-section');

  // 스크롤 위치에 따른 탭 활성화 로직 (선택 사항)
  ...
  return (
    <div className="product-page-wrapper">
      {/* 헤더 (실제 구현 시 별도 컴포넌트 분리 추천) */}
      <header id="header-container">
        {/* header.html 내용이 들어갈 자리 */}
      </header>
          ...
          <nav className="product-tabs">
            <ul>
              <li className={activeTab === 'spec-section' ? 'active' : ''}>
                <a href="#spec-section" onClick={() => setActiveTab('spec-section')}>상품 상세정보</a>
              </li>
              <li className={activeTab === 'review-section' ? 'active' : ''}>
                <a href="#review-section" onClick={() => setActiveTab('review-section')}>
                  의견/리뷰 <span>1,235</span>
                </a>
              </li>
              <li className={activeTab === 'related-section' ? 'active' : ''}>
                <a href="#related-section" onClick={() => setActiveTab('related-section')}>연관상품</a>
              </li>
            </ul>
          </nav>
            ...
            <article className="review-item">
              ...
              <div className="review-content-wrapper">
                <div className="review-text">
                  <h4 className="review-title">고3 아들이 워낙에 좋아하는 운동화라서 또 구입</h4>
                  <p>교복에도 잘 어울리고 청바지나 일상복에도 잘 어울려서 하나 장만해 놓으면 괜찮은 것 같아요...</p>
              ...
              <thead>
                <tr>
                  ...
                  <th className="current-item">
                    ...
                    <p className="compare-name">나이키 에어포스 1 '07 CW2288-111</p>
                  </th>
                  <th>
                    <div className="compare-img"><img src="af1_black.jpg" alt="" /></div>
                    <p className="compare-name">나이키 에어포스 1 '07 CW2288-001</p>
                  </th>
                </tr>
              </thead>
              <tbody>
